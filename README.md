    ...
    <div class="container">
        ...
        <form id="registrationForm">
            <div class="form-group">
                ...
                <div id="usernameError" class="error">用户名必须为3-20个字符，只能包含字母和数字</div>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="passwordError" class="error">密码必须至少8个字符，包含大小写字母和数字</div>
            </div>
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (validateForm()) {
                    ...
                    const userData = {
                        ...
                        password: document.getElementById('password').value, // 实际应用中不应存储明文密码
